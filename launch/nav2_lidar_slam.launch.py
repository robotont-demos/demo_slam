...
def generate_launch_description():
    ...
    default_params = os.path.join(get_package_share_directory('robotont_navigation'), 'config', 'nav', 'nav2_realsense.yaml')
    ...
    nav2 = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('robotont_navigation'), 'launch', 'nav2_bringup.launch.py')
        ),
        launch_arguments={
